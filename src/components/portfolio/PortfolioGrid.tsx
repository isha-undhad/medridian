...
export default function PortfolioGrid({
  ...
  if (layout === "flex") {
    ...
    return (
      <div className="flex flex-col gap-3 sm:gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 md:items-stretch gap-3 sm:gap-4 mt-1">
  ...
  return (
    <div className="columns-1 gap-4 sm:columns-2 sm:gap-3 lg:columns-3 lg:gap-4">
